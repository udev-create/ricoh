...
<div class="submenu" align='center'>
    <ul>
		...
		<br />
		&nbsp;
		<form action="PHP/cliente_controllers.php" class="myForm" method="POST" onsubmit="return validacion();">
        <br />
		...
		<table id="formulario">
			<tbody>
				...
				<tr>
					...
					<td><input name="direccion" id="direccion" type="text" placeholder="Direccion"></td>
				</tr>
				<tr>
					<td></td>
				</tr>
				<tr>
					...
					<td><input name="correo" id="correo" type="email" placeholder="@Correo"></td>
				</tr>
				<tr>
					<td></td>
				</tr>
				<tr>
					...
					<td><input name="telefono" id="telefono" type="text" placeholder="Telefono"></td>
				</tr>
				...
				<tr>
					...
					<td><input name="producto" id="producto" type="text"/></td>
				</tr>
				<tr>
					<td></td>
				</tr>
				<tr>
					<td><label>Cotizaci&oacute;n:</label></td>
					<td><textarea name="cotizacion" id="cotizacion"></textarea></td>
				</tr>
				<tr>
					<td></td>
				</tr>
		...
		<br />
		<input align='center'  onclick="crear();" type="submit" value="AGREGAR" />
