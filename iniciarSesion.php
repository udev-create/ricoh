...
<div class="submenu">
	<br />
	&nbsp;
	<form action="PHP/comparaSesion.php" class="myForm" method="POST" onsubmit="return validacion();">
	<div align='center'>
	...
	<table id="formulario">
			...
			<tr>
				...
				<td><input id="correo" name="correo" type="email" /></td>
			</tr>
			<tr>
				<td></td>
			</tr>
