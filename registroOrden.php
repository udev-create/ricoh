...
<script src="js/validarOrden.js"></script>
</head>
<body>
...
<div class="submenu" align='center'>
    <ul>
		...
		<br />
		<br />
		<form action="PHP/orden_controllers.php" class="myForm" method="POST" onsubmit="return validacion();">
		<br />
		...
		<table id="formulario">
			<tbody>
				<tr>
					<td><label>Correo Cliente:</label></td>
					<td><input name="correo" id="correo" type="text" placeholder="Correo"></td>
				</tr>
				<tr>
					<td></td>
				</tr>
				<tr>
					...
					<td><input name="producto" id="producto" type="text" placeholder="Producto"></td>			
				</tr>
				<tr>
					<td></td>
				</tr>
				<tr>
					<td><label>Fecha de Acquisition:</label></td>
					<td><input name="acquisition" id="acquisition" type="date" placeholder="Acquisition"></td>
		...
		<br />
		<br />
		<input onclick="crear();" type="submit" value="ORDENAR" />
		</form>
		</li>
	</ul>
</div>
